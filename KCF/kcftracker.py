...
# KCF tracker
class KCFTracker:
    def __init__(self, hog=False, fixed_window=True, multiscale=False, is_deterministic=False):
        self.is_deterministic = is_deterministic
        self.lambdar = 0.0005  # regularization
        self.padding = 2  # extra area surrounding the target
        ...
        self.name = 'KCF_{}_{}_{}_{}_{}_{}_{}'.format(self.feature_type, self.scale_type, self.lambdar,
                                                self.padding, self.template_size,
                                                self.scale_step, self.scale_weight)
